...
const AboutSection = () => {
  ...
  return (
    <section className="bg-[#FFFF00] text-black py-[115px] px-[161px]">
      ...
      <button className="group grid grid-cols-1 hover:grid-cols-3 gap-4 items-center text-[20px] leading-[30px] tracking-[-0.015em] font-semibold py-[5px] px-[20px] transition transform rounded-full border-2 border-black hover:duration-700" onClick={() => navigate('/about')}>
