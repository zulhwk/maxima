      ...
      <div className="h-[944px] flex justify-center flex-col items-center" style={{ background: "rgba(0, 0, 0, 0.8)" }}>
        <div className="mb-[193px]">
          ...
          <div className="flex justify-center">
            <button className="text-[24px] leading-[23px] tracking-[-0.015em] font-semibold py-[14px] px-[25px] rounded-full border-[1.70516px] border-[#FFFF00] text-black bg-[#FFFF00]" onClick={() => handleClick()}>Get in Touch</button>
          </div>
          </div>
        </div>
      </div>
